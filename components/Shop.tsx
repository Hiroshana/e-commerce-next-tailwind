...
import ShopBrandList from "./ShopBrandList";
  ...
  return (
    <div className="border-t">
      <CustomContainer className="mt-5">
          ...
          <div className="flex items-center justify-between">
            ...
            {(selectedCategory !== null ||
              ...
              <button
                ...
                className="text-shop-btn-dark-green underline text-sm mt-2 font-medium hover:text-shop-dark-red hoverEffect"
              >
                Reset Filters
              </button>
            )}
        ...
        <div className="flex flex-col md:flex-row gap-5 border-t border-t-shop-btn-dark-green/50">
