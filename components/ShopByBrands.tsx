...
const ShopByBrands = async () => {
  ...
  return (
    <div className="mb-10 lg:mb-20 bg-gray-100 p-5 lg:p-7 rounded-md">
      ...
      <div className="grid gird-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-16  p-2 shadow-sm hover:shadow-shop-green/10 py-5">
        {extraData?.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-3 group text-shop-light-text hover:text-shop-green"
          >
